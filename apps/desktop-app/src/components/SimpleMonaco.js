...
/**
 * SimpleMonaco - Plain Monaco editor with zero overhead
 * No decorations, no custom logic, just fast editing
 * Updates editor when file is opened (Redux content changes)
 */
function SimpleMonaco() {
  ...
  const handleMount = (editor, monaco) => {
    ...
    // Click on glyph margin eye icon: toggle #ai-hide tag on that line and notify Electron (for advanced menu)
