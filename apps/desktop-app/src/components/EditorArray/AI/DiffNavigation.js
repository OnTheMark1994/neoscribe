...
/**
 * DiffNavigation - Navigation bar for AI proposals in EditorArray
 * 
 * Uses aiChangesSlice for array editor state (not aiSlice which is for Monaco).
 * Shows change count, previous/next buttons, and accept all/reject all.
 */
